...
const Calendar = () => (
  <CalendarStyle>
    ...
    <Nav />
    <Layout>
      <h1>Calendário</h1>O campeonato inicia-se com dois qualificadores que irão
      decorrer no dia 11 a 14 de Novembro...
      ...
      <p className="zi-caption">
        Os jogadores devem estar presentes às 20h45 para arrancar o lobby.
      </p>
